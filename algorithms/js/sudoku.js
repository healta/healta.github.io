...
function checkgrid(array) {
  if (
    checkgrid1(array) == true &&
    checkgrid2(array) == true &&
    checkgrid3(array) == true
  ) {
    return true;
  } else {
    return false;
...
function isitsolved(array) {
  if (
    checkgrid(array) == true &&
    checkcollums(array) == true &&
    checkrows(array) == true
  ) {
    return true;
  } else {
    return false;
...
function changevalue(array, listempty) {
  ...
  while (
    ...
    checkrows(array) == false ||
    checkgrid(array) == false
  ) {
...
solve.onclick = function solve() {
  ...
  image.src =
    "https://media.gettyimages.com/photos/venomous-snake-picture-id157479804";
};
